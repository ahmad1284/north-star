...
## Success Criteria
- [ ] Pure functions, no I/O in the core; data injected
- [ ] Eligibility verdict + reasons (rule-by-rule: passes, points, grade floors)
- [ ] Strength score (0–1) from grades in programme's valued subjects, documented formula
- [ ] Unit tests cover: eligible/ineligible on points, on passes, on grade floors,
